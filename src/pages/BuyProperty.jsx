...
const SearchCard = ({ item }) => (
  <Link to={`/property/${item.id}`} className="flex flex-col group cursor-pointer">
    {/* Image container kept for layout (aspect ratio), but image tag removed */}
    <div className="relative aspect-[4/3] overflow-hidden rounded-lg bg-gray-200 transition-colors hover:bg-gray-300">
      ...
      <div className="mt-4 pt-3 border-t border-gray-100 flex justify-between items-center">
        ...
        {item.agentImage && (
          <div className="flex items-center gap-2">
            ...
            {/* Agent Image Removed - replaced with gray circle */}
...
// --- DATA (No image URLs needed anymore, but keeping structure) ---
const baseResults = [
  { 
    id: 1, 
    ...
    agency: 'Sotheby’s', 
    tags: ['1/9'],
    agentName: 'Agent A', agentImage: true 
  },
  { 
    id: 2, 
    price: 'Rp 24.500.000.000', 
    priceValue: 24500000000, 
    beds: 4, 
    baths: 3, 
    size: '450 Sqm', 
    ...
    agency: 'Christie’s', 
    tags: ['Video'],
    agentName: 'Agent B', agentImage: true 
  },
  { 
    id: 3, 
    ...
    agency: 'Knight Frank', 
    tags: ['1/33'],
    agentName: 'Agent C', agentImage: true 
  },
  { 
    id: 4, 
    price: 'Rp 15.750.000.000', 
    priceValue: 15750000000, 
    beds: 3, 
    baths: 3, 
    size: '300 Sqm', 
    address: 'Canggu, Bali', 
    agency: 'Savills', 
    tags: ['1/10'],
    agentName: 'Agent D', agentImage: true 
  },
  { 
    id: 5, 
    ...
    agency: 'Local Agency', 
    tags: ['New 5 days ago'],
    agentName: 'Agent E', agentImage: true 
  },
  { 
    id: 6, 
    price: 'Rp 250.000.000.000', 
    priceValue: 250000000000, 
    beds: 8, 
    baths: 8, 
    size: '2000 Sqm', 
    ...
    agency: 'eXp Realty', 
    tags: [],
    agentName: 'Agent F', agentImage: true 
  },
  { 
    id: 7, 
    price: 'Rp 42.000.000.000', 
    priceValue: 42000000000, 
    beds: 5, 
    baths: 5, 
    size: '600 Sqm', 
    ...
    agency: 'Sotheby’s', 
    tags: [],
    agentName: 'Agent G', agentImage: true 
  },
  { 
    id: 8, 
    ...
    agency: 'Local Agency', 
    tags: ['1/28'],
    agentName: 'Agent H', agentImage: true 
  },
];
...
const BuyProperty = () => {
  ...
  return (
    <div className="pt-28 min-h-screen bg-white">
      {/* HERO SECTION - No Image, just Dark Gray Background */}
      <div className="relative h-[520px] w-full bg-gray-900">
        <div className="absolute inset-0 flex flex-col justify-center items-center px-4 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif text-white mb-8 drop-shadow-md">Luxury Real Estate Indonesia</h1>
          <div className="bg-white rounded-lg p-2 flex flex-col md:flex-row items-center gap-2 w-full max-w-4xl shadow-2xl">
            <div className="flex-1 w-full md:w-auto border-b md:border-b-0 md:border-r border-gray-200 px-4 py-2 text-left">
              ...
              <input
                type="text"
                placeholder="City, Region, District"
                value={filters.query}
            ...
            <div className="w-full md:w-48 border-b md:border-b-0 md:border-r border-gray-200 px-4 py-2 text-left">
              ...
              >
                ...
                <option value="0-5000000000">Up to Rp 5 M</option>
                <option value="5000000000-20000000000">Rp 5 M – Rp 20 M</option>
                <option value="20000000000-50000000000">Rp 20 M – Rp 50 M</option>
                <option value="50000000000-">Rp 50 M+</option>
              </select>
            </div>
      ...
      <div className="sticky top-[112px] z-30 bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-screen-2xl mx-auto px-4 py-4">
          <div className="mb-2">
            ...
            <p className="text-xs text-gray-400">Explore homes across Indonesia</p>
          </div>
          ...
          <div className="absolute inset-0 flex items-center justify-center p-4">
            <div className="w-full max-w-2xl bg-white rounded-xl shadow-2xl overflow-hidden">
              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  <div className="text-xs font-semibold uppercase tracking-wide text-gray-500 mb-2">Price Range (IDR)</div>
